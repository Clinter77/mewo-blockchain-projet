...
class Api {
    ...
    async getFirebaseAuthToken() {
        var _a;
        return !this.isUsingApiToken && ((_a = this.auth) === null || _a === void 0 ? void 0 : _a.currentUser) ? await this.auth.currentUser.getIdToken() : null;
    }
    ...
    async syncContractData(name, address, abi, workspaceName, hashedBytecode) {
        if (!name || !address)
    ...
    async syncContractAst(address, ast, workspaceName) {
        if (!address || !ast)
