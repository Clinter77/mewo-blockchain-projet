...
export declare class Api {
    ...
    syncContractData(name: string, address: string, abi: any[] | null, workspaceName: string | undefined, hashedBytecode: string | undefined): Promise<any>;
    syncContractAst(address: string, ast: any, workspaceName: string | undefined): Promise<any>;
}
